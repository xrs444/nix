...
let
  vmSpecs = [
    {
      name = "v-k8s-xsvr4";
      vcpu = "5";  # Same spec as xsvr3
      memory = "24";  # GiB, same spec as xsvr3
      nicType = "bridge";
      hostNic = "bridge22";
      mac = "52:54:00:8d:2e:fd";  # Generated — distinct from xsvr1 (..ef), xsvr2 (..fe), xsvr3 (..ff)
      autostart = true;
      firmware = "efi";
      storage = {
        path = "/vm/v-k8s-xsvr4/v-k8s-xsvr4.qcow2";
      };
      extraDrives = [
        {
